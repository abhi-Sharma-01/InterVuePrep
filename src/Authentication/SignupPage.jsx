  ...
  const handleGoogle = async () => {
    try {
      ...
      if (code === "auth/popup-closed-by-user") {
        msg = "Google sign-in was cancelled before completion.";
      } else if (code === "auth/popup-blocked") {
        msg = "Popup was blocked by the browser. Please allow popups and try again.";
      } else if (code === "auth/unauthorized-domain") {
        msg = "This domain is not authorized in Firebase. Add it in Firebase Authentication settings.";
      } else if (code === "auth/operation-not-allowed") {
        msg = "Google sign-in is not enabled in Firebase Authentication.";
